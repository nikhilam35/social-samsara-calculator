        ...
        <>
            ...
            <motion.div
                ...
                className={clsx(
                    ...
                    isMobile ? "bottom-0 left-0 right-0 p-4 flex justify-center bg-black/80 backdrop-blur-md border-t border-white/10" : "bottom-6 right-6 pointer-events-none"
                )}
            >
                    ...
                    <div className="relative">
                        ...
                        {isMobile && (
                            <button
                                ...
                                className="absolute -top-3 left-1/2 -translate-x-1/2 w-12 h-1.5 bg-gray-600 rounded-full mb-4"
                            />
                        )}
                        ...
                        <div
                            ...
                            className={clsx(
                                "cursor-pointer bg-[#1a1a1a] border border-white/10 rounded-2xl p-5 shadow-2xl backdrop-blur-lg bg-opacity-95 hover:border-white/30 transition-colors",
